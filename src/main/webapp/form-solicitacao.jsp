...
<form action="inserir-solicitacao" method="post" enctype="multipart/form-data">
    ...
    <div id="solicitacaoContainer"></div>
...
function adicionarSolicitacao() {
    ...
    clone.querySelector('[data-name="materialServico"]').name = "solicitacoes[].materialServico";
    clone.querySelector('[data-name="unidade"]').name = "solicitacoes[].unidade";
    clone.querySelector('[data-name="quantidade"]').name = "solicitacoes[].quantidade";
    clone.querySelector('[data-name="descricao"]').name = "solicitacoes[].descricao";
